...
class NewItems {
    ...
    static var bookstoreDummy: [Bookstore] = [
        ...
        Bookstore(images: [UIImage(named: "무사이책방1")!, UIImage(named: "무사이책방2")!, UIImage(named: "무사이책방3")!, UIImage(named: "무사이책방4")!, UIImage(named: "무사이책방5")!, UIImage(named: "무사이책방6")!, UIImage(named: "무사이책방7")!, UIImage(named: "무사이책방8")!, UIImage(named: "무사이책방8")!, UIImage(named: "무사이책방10")!, UIImage(named: "무사이책방11")!] , name: "무사이책방", address: "부산광역시 북구 산성로12번길 21 (화명동 , 우신아파트상가) 지하 1층", telNumber: "051-362-7004", emailAddress: "mousai0042@naver.com", instagramURL: "https://www.instagram.com/mousai.official", businessHour: BusinessHour(monday: "12:00 ~ 19:00",tuesday: "12:00 ~ 19:00", wednesday: "12:00 ~ 19:00", thursday: "12:00 ~ 20:00", friday: "12:00 ~ 20:00", saturday: "12:00 ~ 20:00", sunday: "12:00 ~ 18:00", etc: "" ), description: """
            무사이 책방은 복합문화공간 무사이 안에 자리하고 있습니다. 신간과 정기간행물, 그리고 독립출판물을 만날 수 있습니다. 북토크, 글쓰기 강좌, 그리고 독서모임과 같이 책을 매개로 하는 여러가지 프로그램도 기획하고 있습니다. '무사이 책방'은 널리 알려진 책보다는, 알려질 필요가 있다고 생각하는 책을 소개합니다. 그동안 미처 알지 못했던 취향을 발견하는 공간이 되었으면 바람을 갖고 오늘도 다양한 목소리에 귀를 기울입니다.
            """, location: Location(latitude: 35.2383705, longitude: 129.0156939)),
        
        Bookstore(images: [UIImage(named: "소요서가1")!, UIImage(named: "소요서가2")!, UIImage(named: "소요서가3")!] , name: "소요서가", address: "서울특별시 중구 청계천로 160 (산림동 , 세운청계상가) 바열 309호", telNumber: "02-2272-1517", emailAddress: "soyoseoga@gmail.com", instagramURL: "https://www.instagram.com/soyoseoga", businessHour: BusinessHour(monday: "휴무",tuesday: "12:00 ~ 20:00", wednesday: "12:00 ~ 20:00", thursday: "12:00 ~ 20:00", friday: "12:00 ~ 20:00", saturday: "12:00 ~ 20:00", sunday: "휴무", etc: "" ), description: """
...
//""", location: Location(latitude: 35.9621863, longitude: 126.7007825)),
        ...
        Bookstore(images: [UIImage(named: "서실리책방1")!,UIImage(named: "서실리책방2")!,UIImage(named: "서실리책방3")!,UIImage(named: "서실리책방4")!,UIImage(named: "서실리책방5")!] , name: "서실리책방", address: "제주특별자치도 제주시 구좌읍 중산간동로 2262", telNumber: "010-5112-0406", emailAddress: "silver367@naver.com", instagramURL: "https://www.instagram.com/seosilli_books/", businessHour: BusinessHour(monday: "11:00 ~ 16:00",tuesday: "11:00 ~ 16:00", wednesday: "휴무", thursday: "휴무", friday: "11:00 ~ 16:00", saturday: "11:00 ~ 16:00", sunday: "11:00 ~ 16:00", etc: "" ), description: "조용한 마을에 있는 조용하고 작은 책방", location: Location(latitude: 33.4713168, longitude: 126.784255)),
        
        Bookstore(images: [UIImage(named: "속초동아서점1")!,UIImage(named: "속초동아서점2")!,UIImage(named: "속초동아서점3")!,UIImage(named: "속초동아서점4")!] , name: "속초 동아서점", address: "강원도 속초 수복로 108 (교동)", telNumber: "033-632-1555", emailAddress: "duhgun@naver.com", instagramURL: "https://www.instagram.com/bookstoredonga", businessHour: BusinessHour(monday: "09:00 ~ 21:00",tuesday: "09:00 ~ 21:00", wednesday: "09:00 ~ 21:00", thursday: "09:00 ~ 21:00", friday: "09:00 ~ 21:00", saturday: "09:00 ~ 21:00", sunday: "휴무", etc: "" ), description: """
            1956년에 개점하여 3대째 운영 중인 강원도 속초의 동네서점.
            """, location: Location(latitude: 38.2008638, longitude: 128.5808805)),
        
        Bookstore(images: [UIImage(named: "노말에이1")!,UIImage(named: "노말에이2")!,UIImage(named: "노말에이3")!,UIImage(named: "노말에이4")!, UIImage(named: "노말에이5")!,UIImage(named: "노말에이6")!,UIImage(named: "노말에이7")!] , name: "노말에이", address: "서울특별시 중구 마른내로 12 (저동2가) 4층", telNumber: "070-4681-5858", emailAddress: "normala.kr@gmail.com", instagramURL: "https://www.instagram.com/normala.kr", businessHour: BusinessHour(monday: "12:00 ~ 18:00",tuesday: "12:00 ~ 18:00", wednesday: "12:00 ~ 18:00", thursday: "12:00 ~ 18:00", friday: "12:00 ~ 18:00", saturday: "13:00 ~ 18:00", sunday: "12:00 ~ 18:00", etc: "" ), description: """
        ...
        Bookstore(images: [UIImage(named: "일상서재1")!,UIImage(named: "일상서재5")!,UIImage(named: "일상서재2")!,UIImage(named: "일상서재3")!,UIImage(named: "일상서재4")!] , name: "일상서재", address: "충청남도 천안시 동남구 대흥로 207 (대흥동) 1층", telNumber: "010-8812-0152", emailAddress: "uiyonglee@naver.com", instagramURL: "https://www.instagram.com/dailybooooks", businessHour: BusinessHour(monday: "휴무",tuesday: "13:00 - 21:00", wednesday: "13:00 - 21:00", thursday: "13:00 - 21:00", friday: "13:00 - 21:00", saturday: "13:00 - 21:00", sunday: "휴무", etc: "" ), description: """
    ...
    static let curationDummy: [Curation] = [
        ...
        Curation(id: "3", title: "한가로운 일상,", subTitle: "잠시 쉬어갈 장소가 필요 없는 분들에게", mainImage: "밤산책방1", headText: """
            밤산책방\n

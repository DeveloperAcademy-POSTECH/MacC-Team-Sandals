...
final class CurationCell: UICollectionViewCell {
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
            ...
            titleStack.leadingAnchor.constraint(
                equalTo: labelBackgroundView.leadingAnchor,
                constant: 16
            ),
            titleStack.trailingAnchor.constraint(
                equalTo: labelBackgroundView.trailingAnchor,
                constant: 16
            ),
    ...
    // MARK: Configure Cell
    func configureCell(_ curation: Curation) {
        titleLabel.text = curation.title
        subTitleLabel.text = curation.subTitle
    }
}
